      ...
      <div className="container mx-auto">
        <div className="flex flex-col gap-y-8 md:flex-row md:items-center md:gap-x-20 ">
          <div className="flex-1 text-center font-secondary md:text-left">
            ...
            >
              Sou estudante de Engenharia de Computação na Universidade Federal do Paraná, campus Apucarana.
                        </motion.p>
            ...
            >
              ...
              <a className="text-gradient btn-link" href="https://www.linkedin.com/in/leonardo-simoes-laraya-554b01341/" target="_blank">
                Meu portifolio
              </a>
            </motion.div>
            <div className="flex gap-x-2 max-w-max mx-auto md:mx-0">
              <a href="https://github.com/LeonardoLaraya" target="_blank">
                <FaGithub />
              </a>
              <a href="https://www.linkedin.com/in/leonardo-simoes-laraya-554b01341/" target="_blank">
                <FaLinkedin />
              </a>
              <a href="https://www.facebook.com/profile.php?id=61563767377344" target="_blank">
                <FaFacebook />
              </a>
            </div>
          </div>
