      ...
      <div className="container mx-auto">
        <div className="flex flex-col gap-y-8 md:flex-row md:items-center md:gap-x-20 ">
          <div className="flex-1 text-center font-secondary md:text-left">
            ...
            >
              <button className="btn btn-lg"><a href="mailto:arthurpetroli@alunos.utfpr.edu.br">Entre em contato</a></button>
              <a className="text-gradient btn-link" href="https://www.linkedin.com/in/arthur-petroli-351013144/" target="_blank">
                Meu portifolio
              </a>
            </motion.div>
            <div className="flex gap-x-2 max-w-max mx-auto md:mx-0">
              <a href="https://github.com/arthurpetroli" target="_blank">
                <FaGithub />
              </a>
              <a href="https://www.linkedin.com/in/arthur-petroli-351013144/" target="_blank">
                <FaLinkedin />
              </a>
              <a href="https://www.facebook.com/arthur.petroli.9" target="_blank">
                <FaFacebook />
              </a>
            </div>
          </div>
