        ...
        <div className="flex flex-col gap-y-8 md:flex-row md:items-center md:gap-x-20 ">
          <div className="flex-1 text-center font-secondary md:text-left">
            ...
            >
              ...
              Sou freelancer e desenvolvedor autônomo, ênfase em back-end.
            </motion.p>
            ...
            >
              <button className="btn btn-lg"><a href="mailto:nstrapasson@alunos.utfpr.edu.br">Entre em contato</a></button>
            </motion.div>
            <div className="flex gap-x-2 max-w-max mx-auto md:mx-0">
              <a href="https://github.com/NickStrapasson" target="_blank">
                <FaGithub />
              </a>
              <a href="https://www.linkedin.com/in/nicolas-strapasson-031a1824a/" target="_blank">
                <FaLinkedin />
              </a>
            </div>
          </div>
