      ...
      <div className="container mx-auto">
        <div className="flex flex-col gap-y-10 md:flex-row md:items-center md:gap-y-0">
          ...
          >
            ...
            <p>
              Sou membro da empresa junior therion na qual trabalha com desenvolvimento
              web, impressão e prototipagem 3D e vários outros serviços da area. Curto praticar esportes, desde futebol e
              volêi, como também fazer musculação.
            </p>
            ...
            <div className="flex items-center gap-x-5">
              <button className="btn btn-lg"><a href="mailto:guilhermefranco@therionej.com.br">Vamos conversar</a></button>
