      ...
      <div className="container mx-auto">
        <div className="flex flex-col gap-y-10 md:flex-row md:items-center md:gap-y-0">
          ...
          >
            ...
            <h3 className="h3">sou desenvolvedor junior</h3>
            <p>
            Estudante de Engenharia, atualmente em treinamento na empresa júnior Therion, com foco em desenvolvimento web,
            impressão, prototipagem 3D e outros serviços inovadores da área
            </p>
