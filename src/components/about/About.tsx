      ...
      <div className="container mx-auto">
        <div className="flex flex-col gap-y-10 md:flex-row md:items-center md:gap-y-0">
          ...
          >
            ...
            <p>
              Atualmente participo da empresa junior therion na qual trabalha com desenvolvimento
            ...
            <div className="flex items-center gap-x-5">
              <button className="btn btn-lg"><a href="mailto:nathaliarng@outlook.com">Vamos conversar</a></button>
              <a href="https://github.com/nath-rodrigues" target="_blank" className="text-gradient btn-link">
                Meu Portifolio
              </a>
            </div>
          </motion.div>
