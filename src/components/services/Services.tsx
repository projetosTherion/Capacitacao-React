      ...
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row">
          ...
          <motion.div
            ...
            className="flex-1 md:bg-services bg-no-repeat bg-contain mix-blend-lighten"
            style={{ backgroundPosition: "center bottom" }} // Adicionado para mover a imagem para baixo
          >
            <h2 className="h2 text-accent">O que faço.</h2>
            <h3 className="h3  text-accent">Entusiasta em programar e aprender</h3>
